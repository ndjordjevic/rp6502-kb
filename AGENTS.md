...
Maintained by AI agents following Karpathy's LLM Wiki pattern.

The AI agent maintains the wiki. The human curates sources, asks questions, and guides the analysis.
...
11. Update `AGENTS.md` and `CLAUDE.md` if the ingest introduces new source categories, raw-folder conventions, domain vocabulary, or workflow changes that future sessions need to know about.
