...
- ✅ **"Programming The Raspberry Pi Pico/W In C" (Fairhead, 3rd ed. 2025)** → `raw/pdfs/Programming The Raspberry Pi Pico_W In C, Third Edition_nodrm.pdf` — ingestion plan at `wiki/inbox/fairhead-pico-c-ingest-plan.md`
...
- 👉 Ingest **Fairhead** — "Programming The Raspberry Pi Pico/W In C" (follow `wiki/inbox/fairhead-pico-c-ingest-plan.md`)
...
| Entities | 7 |
| Concepts | 19 |
| Topics | 2 (overview, version-history, known-issues) |
| Inbox | 1 (fairhead plan) |
| **Total pages** | **~40** |
